...
public class FirebaseHelper {
    ...
    /**
     * Notificar a los contactos de mi cambio de status
     * @param online
     */
    private void notifyContactsOnConnectionChange(boolean online) {
    ...
    /**
     * Notificar a los contactos de mi cambio de status, y mirar si cierro sesion
     * @param online
     * @param signoff
     */
    private void notifyContactsOnConnectionChange(final boolean online, final boolean signoff) {
        ...
        getMyContactsReference().addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                // Tiene que ir despues del aviso a los usuarios
                if (signoff) {
